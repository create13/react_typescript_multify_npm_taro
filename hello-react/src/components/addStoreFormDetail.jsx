// addStoreFormDetail、addStoreFormFooter、addStoreFormHeader、addStoreFormTotal是结合redux后书写的内容
...
export default class FormDetail extends Component {
  ...
  changeStatus () {
    ...
    console.log('store.getState.checkCount', store.getState.checkCount)
    this.setState({
      listData: store.getState().listData,
